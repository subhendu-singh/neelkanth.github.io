					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="about-content">
							<div class="about-award">
								<h4>Who we are</h4>
								<p style="text-align:justify;">Our website address is: https://Neelkanthonlinecrcicketid.live</p>
								<h4>Comments</h4>
								<p style="text-align:justify;">When visitors leave comments on the site we collect the data shown in the comments form, and also the visitor’s IP address and browser user agent string to help spam detection.</p>
								...
								<h4>Cookies</h4>
								<p style="text-align:justify;">If you leave a comment on our site you may opt-in to saving your name, email address and website in cookies. These are for your convenience so that you do not have to fill in your details again when you leave another comment. These cookies will last for one year.</p>
								...
								<p style="text-align:justify;">If you request a password reset, your IP address will be included in the reset email.</p>
								...
								<p style="text-align:justify;">Visitor comments may be checked through an automated spam detection service.</p>
							</div>
						</div>
					</div>
				</div>
